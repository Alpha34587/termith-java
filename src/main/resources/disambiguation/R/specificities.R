...
# specificitie  s                         Calculate Lexical Specificity Score (call specificities.probabilities)
...
specificities <-
function(lexicaltable, types=NULL, parts=NULL,sumCol,tabCol) {
    spe <- specificities.probabilities(lexicaltable, types, parts,sumCol,tabCol);
...
function(lexicaltable, types=NULL, parts=NULL,sumCol,tabCol) {
    ...
    F <- sumCol;             # or "T" (the grand total, number of tokens in the corpus).
...
specificities.lexicon <- function(lexicon, sublexicon,sumCol,tabCol) {
    lexicaltable <- lexiconsToLexicalTable(lexicon, sublexicon);
    return(specificities(lexicaltable, NULL, NULL,sumCol,tabCol));
}
