 ...
 */
public class ComputeTotalTermsScoreDelegate extends Delegate {
     ...
     */
    public ComputeTotalTermsScoreDelegate(TermithIndex termithIndex) throws IOException {
     ...
     * @see TermithIndex
     */
    public ComputeTotalTermsScoreDelegate(TermithIndex termithIndex, int poolSize) throws IOException {
