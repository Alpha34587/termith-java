 ...
 */
public class ComputeTotalTermsScoreThread extends Thread{
     ...
     */
    public ComputeTotalTermsScoreThread(TermithIndex termithIndex) throws IOException {
     ...
     * @see TermithIndex
     */
    public ComputeTotalTermsScoreThread(TermithIndex termithIndex, int poolSize) throws IOException {
