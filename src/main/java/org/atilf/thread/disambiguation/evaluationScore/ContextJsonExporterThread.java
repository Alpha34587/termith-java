 ...
 */
public class ContextJsonExporterThread extends Thread{
     ...
     */
    public ContextJsonExporterThread(TermithIndex termithIndex) throws IOException {
     ...
     * @see TermithIndex
     */
    public ContextJsonExporterThread(TermithIndex termithIndex, int poolSize) throws IOException {
