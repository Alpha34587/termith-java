...
public class AggregateTeiTermsDelegate extends Delegate {
     ...
     */
    public AggregateTeiTermsDelegate(TermithIndex termithIndex) throws IOException {
     ...
     * @see TermithIndex
     */
    public AggregateTeiTermsDelegate(TermithIndex termithIndex, int poolSize) throws IOException {
