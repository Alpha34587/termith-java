 ...
 */
public class ExportToJsonThread extends Thread{
    /**
     ...
     */
    public ExportToJsonThread(TermithIndex termithIndex) throws IOException {
     ...
     * @see TermithIndex
     */
    public ExportToJsonThread(TermithIndex termithIndex, int poolSize) throws IOException {
