...
public class ComputeTermsScoreDelegate extends Delegate {
     ...
     */
    public ComputeTermsScoreDelegate(TermithIndex termithIndex) throws IOException {
     ...
     * @see TermithIndex
     */
    public ComputeTermsScoreDelegate(TermithIndex termithIndex, int poolSize) throws IOException {
