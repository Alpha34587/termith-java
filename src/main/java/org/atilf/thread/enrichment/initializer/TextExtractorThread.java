 ...
 * Created on 25/07/16.
 */
public class TextExtractorThread extends Thread{
     ...
     */
    public TextExtractorThread(TermithIndex termithIndex, int poolSize) {
     ...
     * @param termithIndex the termithIndex is an object that contains the results of the process
     */
    public TextExtractorThread(TermithIndex termithIndex) {
